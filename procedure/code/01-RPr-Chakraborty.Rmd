...
The greatest difference is seen in the Hispanic model, in which the coefficient lost magnitude beyond the confidence interval of the GINI-optimized cluster with state ID model.
This shift confirms that the Hispanic coefficient is not robust to changes in analytical decisions, while other coefficients are.
